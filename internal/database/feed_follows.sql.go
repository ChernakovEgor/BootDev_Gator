...
func (q *Queries) DeleteFeedForUser(ctx context.Context, arg DeleteFeedForUserParams) (FeedFollow, error) {
	row := q.db.QueryRowContext(ctx, deleteFeedForUser, arg.Name, arg.Url)
	var i FeedFollow
	err := row.Scan(
		&i.ID,
		&i.CreatedAt,
